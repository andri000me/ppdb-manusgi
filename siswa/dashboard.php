...
<div class="container-fluid">
    ...
    <p class="h6 mb-4 text-gray-700 text-left" style="font-size: 12px;">
        ...
        PPDB Online / <a href="dashboard.php" class="text-gray-700">Siswa</a> / <a href="dashboard.php"
            class="text-gray-700"> Dashboard </a> </p>
                ...
                <div class="card border-left-success mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success text-uppercase" style="font-size: 14px;">SELAMAT
                            DATANG,<br>
                            Calon siswa baru MA NU Sunan Giri Prigen<br>Tahun Pelajaran <?php if (isset($data_setting['tahun_pelajaran'])) {
            ...
            <div class="col-md-12">
                <div class="card border-left-success mb-4">
                    ...
                    <div class="card-body">
                        <div class="text mb-3">
                            <h6 style="font-size: 14px;" class="text-justify">
                                Pendaftaran Siswa Baru di MA NU Sunan Giri Prigen untuk Tahun Pelajaran <?php if (isset($data_setting['tahun_pelajaran'])) {
                                                                                                            echo $data_setting['tahun_pelajaran'];
                                                                                                        }  ?>
                        ...
                        <div class="text-center mt-1">
                            <a href="https://bit.ly/Panduan-Pengisian-Data-PPDB-MANUSGI-2020"
            ...
            <div class="col-md-12">
                <div class="card border-left-success mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-1">
                            <a href="<?= $base_url ?>/cetak/detail_cetak.php?id=<?= $data_pendaftar['id'] ?>"
